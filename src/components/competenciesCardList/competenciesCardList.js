...
export default function CompetenciesCardList({data}) {
    ...
    return (
        <Box pos="relative"> 
            ...
            <Image src={cube} alt="cube" pos="absolute" w={{xl: "300px", lg: '300px', md: '240px', sm: '210px'}} right={{xl: "-130px", lg: '-60px', md: '-70px', sm: (isLargerThan390 ? '-45px' : "-15px")}} bottom={{xl: "-140px", lg: '-80px', md: '-70px', sm: '-45px'}}></Image> 
        </Box>
    )
}
