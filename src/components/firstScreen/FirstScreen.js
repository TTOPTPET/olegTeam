...
export default function FirstScreen(props) {
    ...
    return (
        ...
        <Box bgSize="unset" bgPosition="center" bgRepeat="no-repeat" h="100vh" w='100%' pt={{xl: "66px", lg: '66px', md: '25px', sm: '30px'}} pos="relative" name="firstScreen">
            <Box ml={{xl: "91px", lg: '72px', md: '104px', sm: '72px'}} m={(isLargerThan430 ? null : '0 auto')} display="block" w={{xl: "350px", lg: '210px', md: '120px', sm: '77px'}} >
            ...
            <Box w={{xl: "1600px", lg: '900px', md: '560px', sm: '280px'}} m="0 auto" mt={{xl: "100px", lg: '55px', md: '70px', sm: null}} bg="#2D3748" boxShadow="0px 25px 50px -12px rgba(0, 0, 0, 0.25)" borderRadius="5px" h={{xl: "350px", lg: '270px', md: '380px', sm: '290px'}} pt={{xl: "25px", lg: '46px', md: '67px', sm: '21px'}} pos={{md: "relative", sm: "absolute"}} top={{md: 0, sm: "50%"}} left={{md: 0, sm: "50%"}} transform={{md:"translate(0, 0)" , sm: "translate(-50%, -50%)"}}>
